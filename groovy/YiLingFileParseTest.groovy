...
public class YiLingFileParseTest extends AbstractGwResultParser {
    ...
    public Object execute(Map<String, Object> params) {
        ...
        if(null != pullDate) {
            ...
            from = DateUtil.getFormatDate(DateUtil.getDateStart(DateUtil.addDays(formatDate, -1)), DateUtil.DATA_FORMANT);
            end = DateUtil.getFormatDate(DateUtil.getDateStart(DateUtil.addDays(formatDate, -0)), DateUtil.DATA_FORMANT);
        } else {
            from = DateUtil.getFormatDate(DateUtil.getDateStart(DateUtil.addDays(new Date(), -1)), DateUtil.DATA_FORMANT);
            end = DateUtil.getFormatDate(DateUtil.getDateStart(DateUtil.addDays(new Date(), -0)), DateUtil.DATA_FORMANT);
        }
    ...
    public String downFile(Map<String, Object> params) {
        // 测试
        if (params.)
    }
